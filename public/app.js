...
function renderHelp(m) {
  ...
  <p>Nástroj hromadně upgraduje MikroTik routery a antény na nejnovější RouterOS a firmware. Dělá to opatrně: jedno zařízení po druhém od antén k páteři, vždy se zálohou, s ověřením balíčků před restartem a s kontrolou verze i bezdrátových spojů po něm. Když něco nesedí, zastaví se dřív, než přijde na řadu nadřazený prvek. Nic se nikdy nerestartuje bez ověřených balíčků. Staré kusy s 32 MB RAM (RB711, RB411, RB750, hAP lite) na sedmičku nikdy nejdou, končí na poslední šestce.</p></div>
  ...
  <ol>
    ...
    <li><b>Hotovo.</b> Ve Stavu zařízení je „aktuální“. Zálohy najdeš v detailu zařízení (klik na název).</li>
  </ol></div>
  ...
  <details><summary>„Špatné přihlašovací údaje“</summary><p>Uživatel nebo heslo nesedí. Oprav v tužce ✎ a znovu <b>Zkontrolovat</b>.</p></details>
  ...
  <details><summary>Přeskočí se: „verze vyšla teprve před X dny“ / „první vydání větve“</summary><p>Čerstvé verze mívají chyby. Verze x.y.0 dostala od 7.13 pokaždé do 14 dní opravu, proto se na ni čeká (Nastavení → Verze). Buď počkej, nebo limit sniž.</p></details>
  <details><summary>Přeskočí se: „verze je pro tento HW riziková“</summary><p>Nástroj zná verze s doloženou regresí pro konkrétní hardware (60 GHz 7.19.4, RB2011 7.21–7.22, RB3011 7.22–7.24.0, hAP ac2/ax 7.22.0–7.22.2, CRS3xx 7.14.1 a další) i obecné (7.17, 7.19, 7.20, 7.23.4, 7.24.0). Na ty se neupgraduje; nejnovější verze kanálu je zpravidla mimo seznam.</p></details>
  <details><summary>„v7 se na tenhle HW nenahrává“ / cíl přepnut na v6</summary><p>Taková zařízení nástroj sám cílí na poslední v6 long-term. Kdo v7 chce i tak, zaškrtne u zařízení (tužka ✎) „povolit v7 i přes doporučení“; u MIPS-LE to nejde vůbec. Seznam je v sekci níže.</p></details>
  <details><summary>Přeskočí se: „ve flash není místo“</summary><p>Zařízení s 16 MB flash mají na balíček málo místa. Nahrání se zkusí přes RAM a při neúspěchu se vše uklidí. Když to nejde ani tak, pomůže jen Netinstall (fyzicky u zařízení). Kusy s 16 MB flash na velmi staré verzi (pod 6.45) se blokují úplně: u nich instalace z RAM prokazatelně umírá. Po upgradu se hlídá, kolik místa zbývá.</p></details>
  <details><summary>„málo volné RAM“ a restart před upgradem</summary><p>Když zařízení nemá dost volné paměti na odložení balíčku, nástroj ho nejdřív restartuje (paměť se po měsících provozu fragmentuje), počká na návrat spojů a zkusí kontrolu znovu. Teprve když je RAM málo i po čistém restartu, položka se přeskočí. Zařízení s 32 MB RAM se na v7 nedávají vůbec, končí na poslední šestce.</p></details>
  <details><summary>Přeskočí se: „v kořeni routeru jsou cizí balíčky .npk“</summary><p>Někdo tam nechal soubor .npk, který by se při restartu nainstaloval. Smaž ho ve Winboxu (Files) a znovu <b>Zkontrolovat</b>. Cizí soubor .fwf blokuje upgrade firmwaru, ten se pak přeskočí.</p></details>
  <details><summary>Přeskočí se: „vadné bloky flash“, „device-mode flagged“</summary><p>Vadné bloky nad 5 % znamenají umírající NAND, zápis nové verze by mohl zařízení umrtvit; nejdřív Netinstall nebo výměna. „Flagged“ je příznak, že RouterOS detekoval kompromitaci (zářijové SSH zranitelnosti 2026); zařízení prověř (cizí účty, skripty) a pak příznak zruš.</p></details>
  <details><summary>Přeskočí se: „přechod v6→v7 s dynamickým routingem“</summary><p>Router má BGP/OSPF/routing filtry. Ve v7 se jejich konfigurace mění a chce to ruční kontrolu odborníkem. Tohle zařízení nech na něj, nebo povol v Nastavení.</p></details>
  <details><summary>Co se hlídá u bezdrátových spojů</summary><p>Sken si pamatuje, na jakém AP je stanice, kolik klientů má sektor a s kým je spojený 60 GHz spoj. Po každém restartu se čeká (výchozí 12 min), až se stanice zaregistruje ke stejnému AP, sektoru se vrátí aspoň 80 % klientů a 60 GHz spoj má MCS ≥ 1. Když ne, položka selže a job se zastaví. Ovladač rádia (wireless vs. wifi-qcom) se nikdy nemění, jen ten rozbíjí nv2 a station-bridge. U 60 GHz se hlídá, aby druhý konec spoje byl v seznamu a v jobu.</p></details>
  <details><summary>PoE watchdog a „neovladatelný PoE switch“</summary><p>Sken najde na každém zařízení netwatch nebo scheduler, který při výpadku pingu vypíná PoE port (PoE watchdog). Když se upgraduje zařízení napájené z takového rodiče, nástroj watchdog na rodiči po dobu položky vypne a pak zapne zpět, aby potomkovi neutnul napájení uprostřed zápisu. Když je podle sousedů nad zařízením PoE prvek, který není v seznamu nebo nemá login, upgrade se zablokuje: není jistota, že napájení vydrží. Přidej ten prvek skenem s loginem, v Nastavení přepni blokování na varování, nebo u konkrétního zařízení zaškrtni „ignorovat PoE ovladatelnost“ (třeba když víš, že nad ním PoE watchdog není).</p></details>
  <details><summary>Souběh s jiným jobem nebo uživatelem</summary><p>Joby běží nezávisle, síť ne. Před každým restartem nástroj zkontroluje, jestli jiný uživatel právě neupgraduje zařízení fyzicky nad nebo pod tímto (rodič/potomek, soused na uplinku, PoE dítě, druhý konec rádiového spoje). Když ano, počká, až ten druhý skončí, a napíše to do logu.</p></details>
  <details><summary>Vlastní restartovací skripty a práva uživatele</summary><p>Scheduler s nočním restartem nebo netwatch s /system reboot se na dobu upgradu vypne a po skončení položky zapne zpět. Uživatel, kterým se nástroj hlásí, musí mít práva write, reboot, ftp, policy, test (skupina full); chybějící práva se hlásí hned při kontrole, ne uprostřed upgradu.</p></details>
  <details><summary>Kvalita rádiových spojů</summary><p>Před upgradem i po každém restartu se do logu zapíše varování, když je spoj špatný: signál stanice nebo klienta sektoru pod −75 dBm, CCQ pod 60 %, u 60 GHz kvalita pod 50 %, MCS 1 nebo chybovost nad 5 %, a také když signál nebo MCS po restartu klesne. Limity jsou v Nastavení. Je to varování, upgrade to nezastaví.</p></details>
  <details><summary>Co se kontroluje po restartu</summary><p>Verze, balíčky, log, rozhraní a IP adresy, bezdrátové spoje, ping na bránu přímo z routeru, počet sousedů, a počty položek v hlavních menu (firewall, routy, bridge, DHCP, uživatelé, fronty…) proti stavu před upgradem. Pokles je varování s odkazem na export v zálohách.</p></details>
  <details><summary>Proč se zařízení před upgradem restartovalo</summary><p>Mělo uptime nad limit (Nastavení → preventivní restart, výchozí 180 dní). Po měsících provozu zařízení po upgradu častěji nenabootuje, po čistém restartu ne. Restart se ověří stejně jako po upgradu (návrat, spoje, potomci).</p></details>
  <details><summary>Zařízení se po upgradu neozvalo</summary><p>Nástroj čeká 15 minut (Nastavení). Když se neozve, položka selže a job se zastaví. Zkontroluj napájení a ping. Většinou jen déle bootuje. Až naběhne, dej u položky <b>znovu</b>; nástroj zjistí aktuální stav a dokončí, co chybí.</p></details>
  <details><summary>Co znamená device-mode basic / home</summary><p>Nástroj chce plné ovládání (advanced). Změnu ale RouterOS vyžaduje potvrdit tlačítkem nebo odpojením napájení; nástroj to udělá jen tam, kde zařízení napájí nadřazený MikroTik přes PoE. Jinak jen upozorní a upgraduje dál, v basic to jde. V režimu home nefunguje scheduler ani fetch, upgrade přes SFTP přesto projde.</p></details>
  <details><summary>Jak upgrade zastavit</summary><p><b>Zastavit po aktuálním zařízení</b>: rozpracované zařízení se v klidu dokončí, pak se job zastaví a jde v něm pokračovat. <b>Zrušit</b>: přeruší se i běžící přenos; před restartem se nahrané balíčky z routeru smažou, po odeslaném restartu se počká na návrat a dokončí ověření. Nezačatá zařízení se vynechají. Naplánovaný job se zrušením jen odplánuje.</p></details>
  <details><summary>Firmware se upgraduje?</summary><p>Ano, po každém upgradu RouterOS se upgraduje i RouterBOOT a udělá se ještě jeden restart. Stav „aktuální, jen firmware“ znamená, že RouterOS sedí a chybí jen tohle. U zařízení s protected-routerboot se firmware nedělá automaticky.</p></details>
  <details><summary>Jak nechat zařízení na v6</summary><p>Tužka ✎ u zařízení → „zůstat na v6“. Zařízení se pak upgraduje jen v rámci šestky (na poslední 6.49.x, ta má i bezpečnostní opravy) a v seznamu má štítek „zůstává na v6“. V pokročilém zobrazení je totéž jako track v6-long-term; track hold znamená nikdy neupgradovat.</p></details>
    ...
    if (udbOn) {
      ...
      const load = async () => {
        ...
        box.innerHTML = `<p>Správce <b>${esc(r.admin.nick)}</b> (uid ${r.admin.id}): ${r.areas.length} oblastí, ${nAps} APček.</p>
          <div class="tablewrap"><table class="grid"><thead><tr><th><input type="checkbox" id="apall" checked title="vše / nic"></th><th>oblast</th><th>APčko</th><th class="num">zařízení AP</th><th class="num">zařízení členů</th><th class="num">už v upgraderu</th></tr></thead><tbody>${r.areas.map(a => a.aps.map(ap => `<tr><td><input type="checkbox" class="apsel" value="${ap.id}" ${ap.active ? 'checked' : ''}></td><td>${esc(a.name)} <span class="muted">(${a.role === 'SO' ? 'správce' : 'zástupce'})</span></td><td>${esc(ap.name)}${ap.active ? '' : ' <span class="badge b-muted">neaktivní</span>'}</td><td class="num">${ap.total - ap.members}</td><td class="num">${ap.members}</td><td class="num">${ap.imported ? `<b>${ap.imported}</b>` : '<span class="muted">0</span>'}</td></tr>`).join('')).join('')}</tbody></table></div>
