...
function renderModal() {
  ...
  if (md.type === 'move') {
    ...
    $('#editf').onsubmit = async (e) => { e.preventDefault(); const b = Object.fromEntries(new FormData(e.target)); b.enabled = !!b.enabled; b.allow_v7 = !!b.allow_v7; b.ignore_poe = !!b.ignore_poe; b.ignore_flagged = !!b.ignore_flagged; { const was = b.stay_v6_init === '1', now = !!b.stay_v6; if (now !== was) b.track = now ? 'v6-long-term' : 'v7-stable'; else if (!adv && now) b.track = 'v6-long-term'; } delete b.stay_v6; delete b.stay_v6_init; b.parent_id = +b.parent_id; b.port = +b.port; b.priority = +b.priority; if ('owner_id' in b) b.owner_id = +b.owner_id; if (!b.password) delete b.password; try { await api(`/devices/${d.id}`, { method: 'PUT', body: b }); toast('uloženo'); closeModal(); await loadState(); render(); } catch (e2) { toast(e2.message, true); } };
