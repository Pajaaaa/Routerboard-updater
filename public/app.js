...
function renderHelp(m) {
  ...
  <details><summary>Zařízení už má u sebe jiný uživatel — jak si ho převzít</summary><p>Každé zařízení má jednoho vlastníka. Když je pod APčkem oblasti, kde jsi v userdb správce (SO) nebo zástupce (ZSO), ukáže se ve výsledku „Natáhnout z userdb“ tlačítko <b>Převzít k sobě</b>: zařízení přejdou pod tvůj účet a dosavadní vlastník je přestane vidět (stejně si je může vzít zpět). Zařízení jiných oblastí převzít nejde; to řeší správce hromadným předáním.</p></details>
