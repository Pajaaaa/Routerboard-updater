...
function renderHelp(m) {
  ...
  <ol>
    ...
    <li><b>Průběh.</b> Na stránce Upgrady vidíš, které zařízení se právě dělá a jaký krok. Stránku můžeš zavřít, běží to na serveru. Jedno zařízení trvá 3 až 10 minut, přechod v6 → v7 i 20 minut. Vlevo dole vidíš svůj běžící job a informačně i to, kolik zařízení právě upgradují ostatní.</li>
  ...
  <details><summary>Přeskočí se: „ve flash není místo“</summary><p>Zařízení s 16 MB flash mají na balíček málo místa. Nahrání se zkusí přes RAM a při neúspěchu se vše uklidí. Když to nejde ani tak, pomůže jen Netinstall (fyzicky u zařízení). Po upgradu se hlídá, kolik místa zbývá.</p></details>
  ...
  <details><summary>Souběh s jiným uživatelem</summary><p>Fronty jsou po uživatelích, síť ne. Před každým restartem nástroj zkontroluje, jestli jiný uživatel právě neupgraduje zařízení fyzicky nad nebo pod tímto (rodič/potomek, soused na uplinku, PoE dítě, druhý konec rádiového spoje). Když ano, počká, až ten druhý skončí, a napíše to do logu.</p></details>
