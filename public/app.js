...
function renderHelp(m) {
  ...
  <p><b>Po restartu:</b> verze, balíčky, log, rozhraní a IP, bezdrátové spoje (stanice na stejném AP, sektoru se vrátí aspoň 80 % klientů, 60 GHz MCS ≥ 1, CAP registrován), ping na bránu z routeru, sousedé, a počty položek v hlavních menu proti stavu před upgradem. Pokles je varování s odkazem na export v zálohách.</p></div>
