...
let pinsFn = () => ({});
/** server sem dá čtení připnutých verzí z nastavení: () => ({ 'v7-stable': '7.24.2', … }); prázdné = sledovat MikroTik.
...
function pins() { try { return pinsFn() || {}; } catch { return {}; } }
let known = {};
...
/** cílové verze kanálů: připnutá verze správce, jinak co nabízí MikroTik. versions[track] = { version, releasedAt, pinned?, newer? }
