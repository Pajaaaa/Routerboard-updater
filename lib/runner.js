...
class Runner extends EventEmitter {
  ...
  async checkScheduled(c, hop, L, W) {
    ...
    if (!sched.length) { W('router nehlásí žádný balíček zařazený k instalaci (/system package … scheduled) — nejde ověřit, že nahrané balíčky přijal; restartuji podle názvu a velikosti'); return { ok: true, checked: false }; }
