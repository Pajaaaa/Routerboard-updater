...
async function plan(info, o) {
  ...
  } else if (cur.major >= 7 && noV7.length && !v7Allowed) warnings.push(`zařízení už běží na v7, přestože je na seznamu nedoporučených (${noV7[0].why}) — upgrade v rámci v7 pokračuje, downgrade se nedělá; zvaž návrat na 6.49.x ručně`);
