...
const NO_V7 = [
  { test: (i) => i.arch === 'mipsle', why: 'MIPS-LE (RB100/RB500/část RB700): RouterOS v7 pro tuhle architekturu neexistuje', src: 'MikroTik Software Specifications', hard: true },
  { test: (i) => i.total_mem && i.total_mem < 60 * MB, why: 'méně než 64 MB RAM: „You should not run v7 on hardware that does not have at least 64 MB of RAM" (OOM bootloop)', src: 'MikroTik Upgrading to v7' },
  { test: (i) => i.arch === 'smips', why: 'smips (hAP lite, hAP mini, cAP lite): 32 MB RAM, v7 bez rezervy, CPU 100 % při skenu, hotspot od 7.20 zvlášť', src: 'MikroTik + fórum' },
  { test: (i) => /^RB(411|433|450|493)(?!G)/i.test(i.board_name || ''), why: 'RB4xx (MIPS 24Kc ≤ 300 MHz): starý NAND, wireless driver od 6.42 na hraně, v7 nepoužitelně pomalá', src: 'fórum (121287, 55806)' },
  { test: (i) => /^RB(711|751|750(?!G)|951-2n|750UP)\b|SXT ?G-2HnD|SXT 5HPnD|OmniTIK 5(?! ac)|Groove(?! 52)|hAP lite|hAP mini/i.test(`${i.board_name || ''} ${i.model || ''}`), why: '32 MB RAM (RB711, RB750, RB751, RB951-2n, SXT G, OmniTIK 5, Groove, hAP lite/mini)', src: 'MikroTik (64 MB RAM) + fórum' },
];
