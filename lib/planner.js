...
const GLOBAL_BAD = {
  ...
  '7.17': 'ztráta bridge/IP/IPv6 nastavení po upgradu (opraveno 7.17.1)', '7.19': 'built-in CA store rozbil importované certifikáty (opraveno 7.19.1)',
  '7.20': 'STP blokuje porty, chybějící connected routy, rozbité neinteraktivní SSH (opraveno 7.20.1–7.20.3)', '7.20.7': 'dynamická switch-cpu VLAN (opraveno 7.20.8)',
  '7.21': 'switch-cpu VLAN, IPv6 RA (opraveno 7.21.1–7.21.3)', '7.23.4': 'nefunkční DHCPv6 (opraveno 7.23.5)', '7.24': 'WireGuard tunel po disable/enable peeru (opraveno 7.24.1)',
};
...
async function plan(info, o) {
  ...
  for (const hop of hops) {
    ...
    for (const kb of KNOWN_BAD) {
      ...
      if (kb.firmwareWarn && out.firmware) warnings.push(kb.firmwareWarn);
    }
