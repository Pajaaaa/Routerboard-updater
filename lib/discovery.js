...
class Discovery {
  ...
  async run(o) {
    ...
    const st = this.state = { ownerId: o.ownerId || 0, startedAt: Date.now(), finishedAt: 0, total: hosts.length, done: 0, open: 0, found: [], added: 0, existing: 0, authFailed: [], notRouterOS: [], errors: [] };
