        ...
        try {
          ...
          for (const cr of credList) {
            ...
            try {
              ...
              const devId = db.insertDevice({ host, port: hostPort, username: cr.username, password_enc: encrypt(cr.password), name: (ent && ent.name) || '', group_name: o.group_name || '', track: o.track || 'v7-stable' });
