...
class Discovery {
  ...
  _blank(o, hosts) {
    return { ownerId: o.ownerId || 0, label: o.label || '', queued: false, position: 0, startedAt: 0, finishedAt: 0, total: hosts.length, done: 0, open: 0, found: [], added: 0, existing: 0, foreign: [...(o.foreign || [])], authFailed: [], notRouterOS: [], winboxOnly: [], errors: [...(o.errors || [])] };
  }
